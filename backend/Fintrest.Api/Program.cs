...
builder.Services.AddScoped<Fintrest.Api.Services.Scoring.V3.IFeature,
    Fintrest.Api.Services.Scoring.V3.Features.Revisions.AnalystRevisionBreadth30dFeature>();
builder.Services.AddScoped<Fintrest.Api.Services.Scoring.V3.IFeature,
    Fintrest.Api.Services.Scoring.V3.Features.Revisions.AnalystRevisionAccelerationFeature>();
...
// Fundamentals Q/P/G sub-score service — §14.1 (migration 021).
builder.Services.AddScoped<Fintrest.Api.Services.Scoring.FundamentalSubscoreService>();
builder.Services.AddSingleton<Fintrest.Api.Services.Scoring.FundamentalSubscoreJob>();
builder.Services.AddHostedService(sp =>
