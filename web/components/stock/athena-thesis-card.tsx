    ...
    return (
      <AthenaSurface className="min-h-[200px]">
        <div className="p-6 flex items-center justify-center">
          ...
          <span className="ml-3 text-sm text-white/70">Athena is analyzing {ticker}…</span>
        </div>
      </AthenaSurface>
    );
  }
      ...
      <AthenaSurface>
        <div className="p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-semibold text-sm">Athena Thesis</h3>
          </div>
    ...
    <AthenaSurface accent={verdictColor}>
      ...
      <div className="flex items-start justify-between gap-4 mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-widest text-white/50">Athena&apos;s Take</p>
      ...
      <p className="text-[10px] text-white/45 leading-relaxed pt-3 border-t border-white/10">
        ...
        Generated by Athena · {new Date(data.generatedAt).toLocaleString()}
      </p>
      </div>
    </AthenaSurface>
  );
